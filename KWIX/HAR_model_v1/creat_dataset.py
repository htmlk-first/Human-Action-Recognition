...
path_dir = 'D://pose dataset/dataset_aihub_dumbbell/raw(1000)' 
...
for idx, action in enumerate(actions):
    ...
    np.save(os.path.join('C://Users/kwuser/Desktop/vscode/JH/kwix/HAR/dataset', f'raw_{action}_{created_time}'),data) #save raw data
    ...
    np.save(os.path.join('C://Users/kwuser/Desktop/vscode/JH/kwix/HAR/dataset', f'seq_{action}_{created_time}'), full_seq_data) #save seq data    
