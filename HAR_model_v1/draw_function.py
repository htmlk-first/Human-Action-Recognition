...
def drawing_Babel_squat(img, landmarks, rate):
    color = set_color(rate)
...
def drawing_Dumbbell_curl(img, landmarks, rate):
    color = set_color(rate)
...
def drawing_Side_lateral_raise(img, landmarks, rate):
    color = set_color(rate)
...
def drawing_Vent_over_low(img, landmarks, rate):
    color = set_color(rate)
